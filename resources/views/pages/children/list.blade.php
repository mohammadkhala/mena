                                ...
                                <div id="page-main-content" class="table-responsive">
                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <td class="td-id">
                                                <a href="<?php print_link("children/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                            </td>
                                            <td class="td-name">
                                            ...
                                            <td class="td-image">
                                                <?php 
                                                    Html :: page_img($data['image'], '50px', '50px', "large", 1); 
                                                ?>
                                            </td>
                                            <!--PageComponentEnd-->
                                            <td class="td-btn">
                                                <a class="btn btn-sm btn-primary has-tooltip "    href="<?php print_link("children/view/$rec_id"); ?>" >
                                                <i class="material-icons">visibility</i> {{ __('view') }}
                                            </a>
                                            <a class="btn btn-sm btn-success has-tooltip "    href="<?php print_link("children/edit/$rec_id"); ?>" >
                                            <i class="material-icons">edit</i> {{ __('edit') }}
                                        </a>
                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal"  href="<?php print_link("children/delete/$rec_id"); ?>" >
                    ...
                    <div class="row align-items-center justify-content-between">    
                        <div class="col-md-auto justify-content-center">    
                            <div class="d-flex justify-content-start">  
                                <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("children/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
