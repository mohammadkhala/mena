                                        ...
                                        <div class="mb-3 row gutter-lg">
                                            ...
                                            <div class=" col-12 col-md-4">
                                                <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <small class="text-muted">{{ __('healthStatusDiagnosis') }}</small>
                                                            <div class="fw-bold">
                                                                <?php echo  $data['health_status_diagnosis'] ; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class=" col-12 col-md-4">
                                                <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <small class="text-muted">{{ __('healthStatusSolution') }}</small>
                                                            <div class="fw-bold">
                                                                <?php echo  $data['health_status_solution'] ; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class=" col-12 col-md-4">
                                                <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <small class="text-muted">{{ __('healthStatusCost') }}</small>
                                                            <div class="fw-bold">
                                                                <?php echo  $data['health_status_cost'] ; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
