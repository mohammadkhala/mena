...
<?php
    $pageTitle = __('addNewHealthStatus'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="health_status-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('health_status.store') }}" method="post">
                            @csrf
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="children_id">{{ __('childrenId') }} <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-children_id-holder" class=" ">
                                                <input id="ctrl-children_id" data-field="children_id"  value="<?php echo get_value('children_id') ?>" type="number" placeholder="{{ __('enterChildrenId') }}" step="any"  required="" name="children_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
